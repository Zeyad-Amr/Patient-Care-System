...
class BluetoothDeviceListEntry extends StatefulWidget {
  ...
  const BluetoothDeviceListEntry({super.key, @required this.device});
      ...
      child: InkWell(
        onTap: () {
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder: (context) {
                return Home(server: widget.device);
              },
            ),
          );
        },
            ...
            Expanded(
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(color: Colors.grey, blurRadius: 20.0, offset: Offset(0, 5), spreadRadius: 0.1)
                  ],
                ),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(15),
